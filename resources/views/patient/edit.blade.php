    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
                <form id="update-form" method="POST" action="{{ route('patient.update', $patient->id) }}" class="mx-auto" style="max-width: 24rem;">
                    @method('PUT')
                    @csrf
                    <div class="mb-3">
                    ...
                    <button type="button" onclick="updatePatient({{ $patient->id }})" class="btn btn-secondary">Actualizar</button>
    ...
    function updatePaciente() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire(
                    '¡Actualizado!',
                    'El registro del Paciente ha sido actualizado',
                    'success'
                ).then(() => {
